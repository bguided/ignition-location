 ...
 * updates to conserve battery when the app is in the background.
 * 
 * When the system broadcasts "Battery OK" to indicate the battery has returned
 * to an okay state, the passive location updates are resumed.
 */
