...
public class LegacyLastLocationFinder implements ILastLocationFinder {
    ...
    protected static String LOG_TAG = LegacyLastLocationFinder.class
            .getSimpleName();
    ...
    public Location getLastBestLocation(int minDistance, long minTime) {
        ...
        if ((this.locationListener != null)
            ...
            String provider = this.locationManager.getBestProvider(
                    this.criteria, true);
            if (provider != null) {
                this.locationManager.requestLocationUpdates(provider, 0, 0,
                        this.singeUpdateListener, this.context.getMainLooper());
            }
        }
    ...
    protected LocationListener singeUpdateListener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            Log.d(LOG_TAG, "Single Location Update Received(lat, long): "
                    + location.getLatitude() + ", " + location.getLongitude());
            if ((LegacyLastLocationFinder.this.locationListener != null)
                    && (location != null)) {
                LegacyLastLocationFinder.this.locationListener
                        .onLocationChanged(location);
            }
            LegacyLastLocationFinder.this.locationManager
                    .removeUpdates(LegacyLastLocationFinder.this.singeUpdateListener);
        }
