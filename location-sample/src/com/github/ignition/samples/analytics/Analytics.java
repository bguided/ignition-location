...
public class Analytics {
    ...
    private static final String ANALYTICS_UID = "";
    ...
    public void trackLocationReceived(Location location, Location currentLocation, long time) {
        ...
        trackPageView("/" + counter + "_location_in_" + in + "_accuracy_" + accuracyIndicator
                + "_age_" + age);
    }
    ...
    public void trackLocationSuccessOrFailure(Location location, long time) {
        ...
        trackPageView("/on_pause_got_location_" + getTimeIndicator(deltaTimeToGetLocation)
                + "_accuracy_" + accuracy);
